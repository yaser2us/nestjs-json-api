...
import { JsonApiModule, ORM_SERVICE } from '@yaser2us/json-api-nestjs';
import { TypeOrmJsonApiModule, createSimpleAccessControlledService } from '@yaser2us/json-api-nestjs-typeorm';
